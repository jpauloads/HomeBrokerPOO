...
public class DAOCliente {
    ...
    public DAOCliente(){
        ...
        bolsa.setDataCriacao(LocalDateTime.now());
        ...
        //setei as data aqui tbm
        adm1.setDataCriacao(LocalDateTime.now());
        adm1.setDataModificacao(LocalDateTime.now());
        ...
        //setei as data aqui tbm
        adm2.setDataCriacao(LocalDateTime.now());
        adm2.setDataModificacao(LocalDateTime.now());
        ...
        //setei as data aqui tbm
        adm3.setDataCriacao(LocalDateTime.now());
        adm3.setDataModificacao(LocalDateTime.now());
    ...
    public void criarCliente(String login, String senha, String nome, String cpf, String endereco, String telefone, String tipoUsuario){
        ...
        //botei a data pra ser inicializada aqui
